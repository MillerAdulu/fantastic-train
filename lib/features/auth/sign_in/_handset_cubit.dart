// lib/features/auth/sign_in/_handset_cubit.dart
...
class FCSignInHandsetCubit extends StatefulWidget {
  const FCSignInHandsetCubit({super.key});

  @override
  State<FCSignInHandsetCubit> createState() => _FCSignInHandsetCubitState();
}

class _FCSignInHandsetCubitState extends State<FCSignInHandsetCubit>
